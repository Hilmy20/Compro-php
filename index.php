    ...
    <header class="header">
        ...
        <nav class="navbar">
            <ul>
                ...
                <li><a href="careerss.php">career</a></li>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="item"> <span class="icon feature_box_col_two"><i class="fa fa-android"></i></span>
                        ...
                        <p>We Have Expertise In Creating Multi-Platform Mobile App Solutions For Both Android And IOS
                            Devices. Using PhoneGap, Xamarin, And React Native, We Offer Custom Mobile App That Runs
                            Smoothly On Multiple Platforms.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
        ...
        <div class="container">
            <div class="row">
                <div class="section-head-1 col-sm-12" style="text-align: center;">
                    ...
                    <p>The objective of IT Company is to enable a large number of youth to take up <br>industry-relevant
                        skill training that will help them<br> in securing a better livelihood.
                    </p>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 footer-contact" style="font-size: 1.5rem;">
                        <h4>Contact Us</h4>
                        <p>
                            Pinang Ranti, Jakarta Timur<br>
                            Indonesia <br>
                            <strong>Phone:</strong> 081234567891<br>
                            <strong>Email:</strong> hilmy@gmail.com<br>
                        </p>
